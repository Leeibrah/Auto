...
public class KisumuDealers extends DashBoardListActivity implements	OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kisumu_dealers);
		
		new GetDialog(this).execute(); 		//show dialog bar
		...
		Adapter = new AlternateRowCursorAdapter(this, mylist,
				R.layout.kisumu_list, from, target);
